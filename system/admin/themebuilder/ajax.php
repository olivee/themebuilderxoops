...
if ($_POST['body_background_texture'] && $_POST['repeat'] && $_POST['bgpos'] && $_POST['bgscroll']){
	/*echo '<style>
	body { 
			background-image:url("texture/'.$_POST['body_background_texture'].'");
			background-repeat:'.$_POST['repeat'].';
			background-attachment:'.$_POST['bgscroll'].';
			background-position:'.$_POST['bgpos'].'; 
	}
	</style>';*/
	echo '<img style="width:60px;" src="admin/themebuilder/test/texture/'.$_POST['body_background_texture'].'" alt="apercu texture">';
}

if ($_POST['body_background_bg'] && $_POST['repeat'] && $_POST['bgpos'] && $_POST['bgscroll']){
	/*echo '<style>
	body { 
			background-image:url("texture/'.$_POST['body_background_bg'].'");
			background-repeat:'.$_POST['repeat'].';
			background-attachment:'.$_POST['bgscroll'].';
			background-position:'.$_POST['bgpos'].'; 
	}
	</style>';*/
	echo '<img style="width:60px;" src="admin/themebuilder/test/texture/bg/'.$_POST['body_background_bg'].'" alt="apercu texture">';
}
